...
public class ReorganizationListener implements ReorganizeListener {
    ...
    public void reorganize(StoredBlock splitPoint, List<StoredBlock> oldBlocks,
        ...
        log.info("Reorganize because of block: " + splitPoint.getHeight() + " hash="
                + splitPoint.getHeader().getHash());
        log.info("Old blocks:");
